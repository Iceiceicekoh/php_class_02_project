   ...
   <main>
    <div class="container-fluid px-4">
     ...
     <div class="card mb-4">
      ...
      <div class="card-body">
       <!-- add to datatable -->
       <table id="datatableSimple" class="table" >
        <thead>
       <tr>
        <th>ID</th>
        <th>User</th>
       ...
       <tbody>
        ...
        <tr>
          ...
          <td><img src="../actions/post_photo/<?php echo $row['file_name'] ?>" alt=" " width="50px"> </td>
          <td>
            <a href="post_edit_form.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-primary"><i class="fa-sharp fa-solid fa-pen-to-square"></i></a>
            <a href="post_detail.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-primary"><i class="fa-sharp fa-solid fa-eye"></i></a>
           <a href="../actions/post_delete.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-primary"><i class="fa-sharp fa-solid fa-trash"></i></a>
          </td>
        </tr>
        <?php endwhile;?>
       </tbody>
